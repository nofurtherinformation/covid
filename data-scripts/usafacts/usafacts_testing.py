...
def usafacts():
    ...
    try:
        ...
        s3.Object('geoda-covid-atlas', 'covid_testing_usafacts.csv').put(Body=open(os.path.join(repo_root, 'docs/covid_testing_usafacts.csv'), 'rb'))
        s3.Object('geoda-covid-atlas', 'covid_positivity_usafacts.csv').put(Body=open(os.path.join(repo_root, 'docs/covid_positivity_usafacts.csv'), 'rb'))
...
def validate_and_process():
    ...
    with open(os.path.join(dir_path, '_working/testing_raw.csv'), encoding='utf-8-sig') as testing_in_file, open(os.path.join(dir_path, '_working/positivity_raw.csv'), encoding='utf-8-sig') as positivity_in_file, open(os.path.join(repo_root, 'docs/covid_testing_usafacts.csv'), 'w+') as testing_out_file, open(os.path.join(repo_root, 'docs/covid_positivity_usafacts.csv'), 'w+') as positivity_out_file:
